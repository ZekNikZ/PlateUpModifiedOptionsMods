...
namespace KitchenPreferModdedOptionsMod
{
    public class Mod : IModInitializer
    {
        ...
        public const string PREF_MULTIPLIER_VANILLA = "weightMultiplierVanilla";
        public const string PREF_MULTIPLIER_MODDED = "weightMultiplierModded";
        public const string PREF_WEIGHT_MAINS = "weightMains";
        public const string PREF_WEIGHT_ADDONS = "weightAddons";
        public const string PREF_WEIGHT_SIDES = "weightSides";
        public const string PREF_WEIGHT_STARTERS = "weightStarters";
        public const string PREF_WEIGHT_DESSERTS = "weightDesserts";
        public const string PREF_WEIGHT_CUSTOMERS = "weightCustomers";
        public const string PREF_WEIGHT_BEHAVIOR = "weightBehavior";
        public const string PREF_FIX_ALGORITHM = "fixCardSelectionAlgorithm";
        ...
        private void SetupPreferences()
        {
            ...
            PreferenceManager
                ...
                .AddOption(PREF_WEIGHT_BEHAVIOR, "RANDOM", new string[] { "DISABLED", "RANDOM", "STRICT" }, new string[] { "Disabled", "Random", "Strict" }, "Weight Behavior", new string[] { "Random: weights will influence chances of card choices (twice the weight = twice the likelihood of being picked). Default: Random", "Strict: cards with higher weight will ALWAYS be offered before those with lower weights. Default: Random" })
                ...
                .AddSubmenu("Weights", "weights")
                    ...
                    .AddOption(PREF_WEIGHT_SIDES, 1, WEIGHT_OPTIONS, WEIGHT_OPTION_LABELS, "Food Cards: Sides")
                ...
                .SubmenuDone()
                .AddSubmenu("Other", "other")
                    .AddOption(PREF_FIX_ALGORITHM, true, new bool[] { true, false }, new string[] { "Enabled", "Disabled" }, "Fix Card Selection", "(Recommended) Fixes a bug with the vanilla card selection algorithm. This DOES change card seeds.")
                .SubmenuDone()
                .AddSpacer();
